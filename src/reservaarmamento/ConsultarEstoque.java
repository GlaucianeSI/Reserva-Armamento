...
public class ConsultarEstoque extends javax.swing.JFrame {
    ...
    public void atualizaTabela(){
        con.conecta();
         String sql = "select * from tipo_material where descricao_material LIKE '"+tvNome.getText().toString()+"%'";
        ...
        while(rs.next()){
          ...
          model.addRow(
                  new Object[]{
                       ...
                       rs.getString("codigo_tipo_material"), 
                       rs.getString("descricao_material"), 
                       rs.getString("quantidade_material")
                                        }
          );
    ...
    private void initComponents() {
        ...
        tbMat.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Cod. Material", "Material", "Quantidade"
            }
        ));
        jScrollPane1.setViewportView(tbMat);

        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ICONES/icones/pesq.png"))); // NOI18N
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(tvNome, javax.swing.GroupLayout.PREFERRED_SIZE, 229, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
